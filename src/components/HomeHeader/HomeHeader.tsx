    ...
    <>
      ...
      >
        ...
        <div className='hidden gap-2 sm:flex'>
          <HeaderNavigationButtonProps content='Trang chủ' to={routes.home}>
          ...
          {/* friend */}
          <HeaderNavigationButtonProps content='Bạn bè' to={routes.friend}>
          ...
          {/* group */}
          <HeaderNavigationButtonProps content='Nhóm' to={routes.group}>
