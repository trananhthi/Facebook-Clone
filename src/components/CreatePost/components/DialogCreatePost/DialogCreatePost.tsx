    ...
    <div>
      ...
      <DialogFooter className='p-4 pt-0'>
        <button
          ...
          disabled={content === ''}
          className='py-1 rounded-md bg-[#0866ff] w-full disabled:bg-[#e4e6eb]'
        >
...
function DialogPrivacyContent({ setOpenPrivacy, privacyPost, setPrivacyPost, userAccount }: PrivacyContentProps) {
  ...
  return (
    <div>
      ...
      <DialogFooter className='flex-col gap-4 mr-3 p-0 pl-2 pt-2 pb-4 border-t-2'>
