function ContactOfHome() {
  return (
    <div className='3xl:w-[360px] 2xl:w-[340px] xl:w-[280px] 900-950:w-[260px] semi-lg:w-[280px] fixed flex flex-col h-[670px] overflow-x-hidden overflow-y-auto custom-scrollbar mt-4'>
      <span className='text-[17px] text-[#65676B] my-2 mx-4 font-semibold'>Cuộc trò chuyện nhóm</span>
      <button className='h-[52px] group hover:bg-[#e4e6e9] mx-2 rounded-md flex items-center'>
